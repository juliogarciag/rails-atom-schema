...
export function loadingError(message, modelPath) {
  return { type: LOADING_ERROR, message, modelPath };
}

export function startModelLoading(modelPath) {
  return { type: START_MODEL_LOADING, modelPath };
}
